...
```{r Figure2, fig.height=11, fig.width=10, warning=FALSE, dev=c('png', 'pdf', 'svg', 'tiff')}
...
```{r Figure3, fig.height=10, fig.width=10, warning=FALSE, dev=c('png', 'pdf', 'svg', 'tiff')}
# numint, freq
...
```{r Figure4, fig.height=7, fig.width=8, warning=FALSE, dev=c('png', 'pdf', 'svg', 'tiff')}
